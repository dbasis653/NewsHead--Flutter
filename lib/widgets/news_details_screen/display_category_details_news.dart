...
class DisplayCategoryDetailsNews extends StatefulWidget {
  const DisplayCategoryDetailsNews({super.key, required this.newsArticle});
  final Articles newsArticle;

  @override
  State<DisplayCategoryDetailsNews> createState() => _DisplayDetailsNewsState();
}

class _DisplayDetailsNewsState extends State<DisplayCategoryDetailsNews> {
  @override
